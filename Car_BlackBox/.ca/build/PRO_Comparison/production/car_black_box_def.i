    ...
    if (i == 4) {
        ...
        if (strncmp(spasswd, upasswd, 4) == 0) {
            ...
            if (attempt_left == 0) {
                ...
                while (min != 0 || sec != 0) {
                    clcd_putch((unsigned char) (min / 10) + '0', (0xC0 + 6));
                    clcd_putch(min % 10 + '0', (0xC0 + 7));
                    clcd_putch((unsigned char) (sec / 10) + '0', (0xC0 + 9));
...
void download_log(void)
{
    ...
    for (i = 0; j < 10; j++)
    {
        ...
        for(j = 0; j < 10; j++)
        {
            download_log[i][j] = read_eeprom_24c04(addr + j);
        }
        download_log[i][11] = '\0';
