...
void display_dashboard(unsigned char event[], unsigned char speed) {
    ...
    clcd_print((const char *)event, (0xC0 + 11));
    ...
    if (i == 4) {
        ...
        if (strncmp(spasswd, upasswd, 4) == 0) {
            ...
            if (attempt_left == 0) {
                ...
                while (min != 0 || sec != 0) {
                    clcd_putch((unsigned char) (min / 10) + '0', (0xC0 + 9));
                    clcd_putch(min % 10 + '0', (0xC0 + 10));
                    clcd_putch((unsigned char) (sec / 10) + '0', (0xC0 + 12));
...
unsigned char view_log(unsigned char key) {
    ...
    clcd_putch(log_no + '0', (0x80 + 10));

    clcd_putch(read_eeprom_24c04(log_no * 10 + 5 + 0), (0xC0 + 2));
    clcd_putch(read_eeprom_24c04(log_no * 10 + 5 + 1), (0xC0 + 3));
    clcd_putch(':', (0xC0 + 4));
    clcd_putch(read_eeprom_24c04(log_no * 10 + 5 + 2), (0xC0 + 5));
    clcd_putch(read_eeprom_24c04(log_no * 10 + 5 + 3), (0xC0 + 6));
    clcd_putch(':', (0xC0 + 7));
    clcd_putch(read_eeprom_24c04(log_no * 10 + 5 + 4), (0xC0 + 8));
    clcd_putch(read_eeprom_24c04(log_no * 10 + 5 + 5), (0xC0 + 9));


    clcd_putch(read_eeprom_24c04(log_no * 10 + 5 + 6), (0xC0 + 11));
    clcd_putch(read_eeprom_24c04(log_no * 10 + 5 + 7), (0xC0 + 12));


    clcd_putch(read_eeprom_24c04(log_no * 10 + 5 + 8), (0xC0 + 14));
    clcd_putch(read_eeprom_24c04(log_no * 10 + 5 + 9), (0xC0 + 15));
...
unsigned char set_time(unsigned char key) {
    ...
    if (key == 0x37) {
        ...
        clear_screen();
        write_ds1307(0x00, (unsigned char)((time[5] & 0x0F) | ((time[4] & 0x0F) << 4)));
        write_ds1307(0x01, (unsigned char)((time[3] & 0x0F) | ((time[2] & 0x0F) << 4)));
        write_ds1307(0x02,(unsigned char)((time[1] & 0x0F) | ((time[0] & 0x0F) << 4)));
        clcd_write(0x0C, 0);
        return 0x13;
    }
            ...
            if (n == 4) {
                ...
                if (r == 4) {
                    if (strncmp(newpasswd, re_enter, 4) == 0) {
                        ...
                        clcd_print("Password", (0x80 + 2));
                        clcd_print("Changed...", (0xC0 + 2));
                        _delay((unsigned long)((2000)*(20000000/4000.0)));
                        return 0x13;
                        ...
                        clear_screen();
                        clcd_write(0x0C, 0);
                        clcd_print("Passwords", (0x80 + 0));
                        clcd_print("Not Matching", (0xC0 + 0));
                        _delay((unsigned long)((1500)*(20000000/4000.0)));
                        clcd_print("Password", (0x80 + 0));
                        clcd_print("Not Changed", (0xC0 + 0));
                        _delay((unsigned long)((1500)*(20000000/4000.0)));
                        clear_screen();
                        return 0x13;
                    }
